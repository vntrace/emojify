...
window.Emojify = require('./modules/emojify');
},{"./modules/emojify":3}],3:[function(require,module,exports){
/**
 * @author thanh.dc
 * @deps jQuery
 */
...
/**
 * Find all emoji target and replace with emoji content
 * @returns {undefined}
 */
...
},{"../data/emoji":1,"../template":5,"underscore":4}],4:[function(require,module,exports){
//     Underscore.js 1.6.0
...
module.exports = {
    emojify: "<% var keys = _.keys(emojies); %>\r\n<div id=\"emojify\">\r\n    <ul class=\"tabs\">\r\n        <% _.each(keys, function(key, index){ %>\r\n        <li class=\"<% if(index === 0) { %> active <% } %>\" data-rel=\"<%= key %>\">\r\n            <a href=\"#\">\r\n                <img src=\"http://static.gate.local.vn/emoji/<%= key %>/<%= emojies[key][0].src %>\" />\r\n            </a>\r\n        </li>\r\n        <% }); %>\r\n    </ul>\r\n    \r\n    <% _.each(keys, function(key, index){ %>\r\n    <ul class=\"tab-container <% if(index === 0) { %> active <% } %>\" data-id=\"<%= key %>\">\r\n        <% _.each(emojies[key], function(emoji){ %>\r\n        <li>\r\n            <a href=\"#\" class=\"<%= emojiClass %>\" data-code=\"<%= emoji.code %>\">\r\n                <img src=\"http://static.gate.local.vn/emoji/<%= key %>/<%= emoji.src %>\" />\r\n            </a>\r\n        </li>\r\n        <% });%>\r\n    </ul>\r\n    <% }); %>\r\n</div>\r\n",
    emojifyCss: "#emojify {\n    display: none; \n    position: absolute;\n    width: 200px;\n    height: 200px;\n    background-color: #FFF;\n    margin-left: 10px;\n    margin-top: 10px;\n    border: 1px solid #ccc;\n}\n\n#emojify ul {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    display: block;\n    width: 100%;\n    float: left;\n}\n\n#emojify .tabs {\n    border-bottom: 1px solid #ccc;\n}\n\n#emojify .tabs li {\n    float: left;\n    height: 25px;\n    width: 25px;\n    text-align: center;\n    border-right: 1px solid #ccc;\n}\n\n#emojify .tabs img{\n    width: 18px;\n    height: 18px;\n}\n\n#emojify .tab-container img{\n    max-width: 100%;\n    height: 30px;\n}\n\n#emojify .tabs li.active {\n    background-color: #ccc;\n}\n\n#emojify .tabs li a {\n\n}\n\n#emojify .tab-container {\n    display: none;\n}\n\n#emojify .tab-container.active {\n    display: block !important;\n}\n\n#emojify .tab-container li {\n    float: left;\n    margin-left: 2px;\n}\n\nbody {\n    padding-top: 50px;\n}\n\n.cons-holder {\n    height: 200px;\n    border: 1px solid #ccc;\n}\n"
};
},{}]},{},[2]);